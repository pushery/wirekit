...
<div>
    ...
    <main>
        <article class="prose">
            ...
            <h2>Team</h2>
            <p>$29 per seat per month. Priority support, private themes.</p>

            <h2>Enterprise</h2>
            <p>Contact sales for volume pricing and SLA terms.</p>

            <h2>FAQ</h2>
            <p>Common questions about billing, licensing, and rollout.</p>
        </article>
    </main>
</div>
