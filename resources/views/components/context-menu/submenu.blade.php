...
@php
    ...
    \Pushery\WireKit\WireKit::warnUnknownProps('context-menu.submenu', $attributes->getAttributes());
    ...
    $subTriggerId = \Pushery\WireKit\Support\DomId::unique(null, 'wk-context-submenu-');
