...
@php
    ...
    \Pushery\WireKit\WireKit::warnUnknownProps('dropdown.submenu', $attributes->getAttributes());
    ...
    $subTriggerId = \Pushery\WireKit\Support\DomId::unique(null, 'wk-dropdown-submenu-');
